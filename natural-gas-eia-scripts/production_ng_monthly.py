...
route2 = {"sum": "ng_gross_withdrawals_production", "whv" : "ng_wellhead_value_marketed_product", 
          "off" : "offshore_gross_withdrawals_ng", "pp" : "ng_plant_processing"}

for route in route2:
    for year in range(init_year, 2026):
        for month in range(1,13):
            savedir = f"natural_gas/production/{route2[route]}/monthly/"
            startyear = str(year)
            endyear = str(year)
